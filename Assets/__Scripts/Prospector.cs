...
public class Prospector : MonoBehaviour {
	...
	// LayoutGame() positions the initial tableau, a.k.a. the "mine"
	void LayoutGame(){
	...
	public void CardClicked (CardProspector cd) {
		...
		case CardState.tableau:
			// Clicking a card in the tableau will check if it is a valid play
	...
	void CheckForGameOver() {
		...
		// If there are still cards in the drawPile, the game is not over 
		if (drawPile.Count > 0) {
			return;
		}
	...
	void ScoreManager(ScoreEvent sEvt) {
		...
		// Rgis second switch statement handles round wins and losses
		switch (sEvt) {
